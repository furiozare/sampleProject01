app.controller('UpdateWarnaModalController', function ($scope, $http, $modalInstance, Warna, warna) {
    $scope.title      = "Mengubah Warna";
    ...
    $scope.save = function () {
        ...
        $scope.CRUD.promise = Warna.updateWarna($scope.warna.id, $scope.data())
