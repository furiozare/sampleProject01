...
class DealerRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function queryOrderByKotaAndNamaASC(QueryBuilder $queryBuilder = null)
    {
        if (is_null($queryBuilder)) {
            $queryBuilder = $this->createQueryBuilder($this->alias);
        }
        ...
        return $queryBuilder
            ->leftJoin($this->alias . '.kota', 'kota')
            ->addOrderBy('kota.nama', Criteria::ASC)
